...
pub enum ReducerEvent {
    ...
    SetTitle(set_title_reducer::SetTitleArgs),
}
...
impl SpacetimeModule for Module {
    fn handle_table_update(
        ...
        match table_name {
            "Character" => client_cache
                .handle_table_update_with_primary_key::<character::Character>(
                    callbacks,
                    table_update,
                ),
    ...
    fn invoke_row_callbacks(
        ...
        reminders.invoke_callbacks::<character::Character>(worker, &reducer_event, state);
    ...
    fn handle_event(
        ...
        match &function_call.reducer[..] {
            ...
            "set_title" => _reducer_callbacks
                .handle_event_of_type::<set_title_reducer::SetTitleArgs, ReducerEvent>(
                    event,
                    _state,
                    ReducerEvent::SetTitle,
                ),
            unknown => {
    ...
    fn handle_resubscribe(
        ...
        match table_name {
            "Character" => client_cache
                .handle_resubscribe_for_type::<character::Character>(callbacks, new_subs),
            "Message" => {
